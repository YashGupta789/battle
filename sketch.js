...
function preload(){
    ...
    burst = loadImage("images/burst.gif");
...
function draw(){
    ...
    if(gameState === "play"){
        ...
        if(cannonGroup.isTouching(vehicleGroup)){
            //vehicleGroup[0].addImage(burst);
            vehicleGroup.scale = 5;
            //vehicleGroup[0].Visiblity = vehicleGroup[0].Visiblity - 5;
            //tint(255,vehicleGroup[0].Visiblity);
        ...
        if(cannonGroup.isTouching(armybaseGroup)){
            //armybaseGroup[0].addImage(burst);
            armybaseGroup.scale = 5;
            //armybaseGroup[0].Visiblity = armybaseGroup[0].Visiblity - 5;
            //tint(255,armybaseGroup[0].Visiblity);
            cannonGroup[0].destroy();
        ...
        if(cannonGroup.isTouching(helicopterGroup)){
            //helicopterGroup[0].addImage(burst);
            helicopterGroup.scale = 5;
            //helicopterGroup[0].Visiblity = helicopterGroup[0].Visiblity - 5;
            //tint(255,helicopterGroup[0].Visiblity);
            cannonGroup[0].destroy();
        ...
        if(cannonGroup.isTouching(truckGroup)){
            cannonGroup[0].destroy();
            truckGroup[0].addImage(burst);
            truckGroup[0].destroy();
            enemyDestroyed = enemyDestroyed+1;
            cannonLeft = cannonLeft + 1;
            truckGroup[0].Visiblity = truckGroup[0].Visiblity - 5;
            //tint(255,truckGroup[0].Visiblity);
            truckGroup.scale = 5;
            burstSound.play();
        } 
